...
const Employee = () => {
    ...
    const employeeUPdate = (sabun) => {
        alert(sabun);
        // navigate('/employeeInsert', {
        //     state: {
        //         dbUrl : db,
        //         sabun: `${sabun}` 
        //     },
        ...
        <>
            ...
            <p className="mb-4">DataTables is a third party plugin that is used to generate the demo table below.
                ...
                <div className="card shadow mb-4">
                    <div className="card-header py-3" style={{ display: 'inline-block' }}>
                        <span className="m-0 font-weight-bold text-primary">사원 정보 </span>
                        <span style={{ float: 'right' }} class="btn btn-primary btn-icon-split btn-sm" onClick={() => employeeUPdate(employee.sabun)}>
